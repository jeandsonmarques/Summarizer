...
class Ui_SummarizerDialog(object):
    def setupUi(self, Dialog):
        ...
        logo_icon = svg_icon("AppLogo.svg")
        if not logo_icon.isNull():
            self.logo_label.setPixmap(logo_icon.pixmap(QSize(36, 36)))
        header_layout.addWidget(self.logo_label, 0, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)

        self.title_label = QLabel(_rt("Summarizer"))
        self.title_label.setProperty("role", "appTitle")
        header_layout.addWidget(self.title_label, 0, Qt.AlignmentFlag.AlignLeft | Qt.AlignmentFlag.AlignVCenter)
        ...
        header_layout.addWidget(self.maximize_btn, 0, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)

        self.theme_btn = QToolButton()
        self.theme_btn.setIcon(svg_icon("Theme.svg"))
        self.theme_btn.setIconSize(QSize(15, 15))
        self.theme_btn.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        self.theme_btn.setText(_rt("Tema"))
        self.theme_btn.setToolTip(_rt("Tema"))
        self.theme_btn.setAutoRaise(True)
        self.theme_btn.setCursor(Qt.CursorShape.PointingHandCursor)
        header_layout.addWidget(self.theme_btn, 0, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)

        self.language_btn = QToolButton()
        self.language_btn.setIcon(svg_icon("Globe.svg"))
        self.language_btn.setIconSize(QSize(15, 15))
        self.language_btn.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonTextBesideIcon)
        ...
        header_layout.addWidget(self.language_btn, 0, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignVCenter)
        ...
        self.ribbon_bar.setSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        ...
        ribbon_layout.addWidget(dados_group, 0, Qt.AlignmentFlag.AlignVCenter)
        ...
        self.sidebar_container.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Expanding)
        ...
        self.pageResultados.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        resultados_layout.setSizeConstraint(QLayout.SizeConstraint.SetNoConstraint)
        ...
        self.results_body.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Expanding)
        ...
        self.results_body_layout.setSizeConstraint(QLayout.SizeConstraint.SetNoConstraint)
        resultados_layout.addWidget(self.results_body, 1)

        self.export_card = QFrame()
        self.export_card.setObjectName("exportCard")
        self.export_card.setSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Maximum)
        ...
        self.integration_placeholder.setAlignment(Qt.AlignmentFlag.AlignCenter)
