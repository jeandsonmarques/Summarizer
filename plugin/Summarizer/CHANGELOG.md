...
## [0.5.0-beta.3] - 2026-06-02

- Prepared the first experimental public release for the QGIS plugin repository.
- Included layer summary, chart, dashboard, model, connection, visualization, and export workflows.
- Kept the release package focused on local QGIS workflows and report-ready analytical outputs.
