...
_FALLBACK = {
    "en": {
        ...
        "Adicionar dados": "Add data",
        "Formatar visual": "Visual format",
        "Format visual": "Visual format",
        ...
        "Aplicacoes e servicos": "Applications and services",
        "Aplicações e serviços": "Applications and services",
        "Planilhas web publicas": "Public web spreadsheets",
        "Planilhas web públicas": "Public web spreadsheets",
        "Arquivos delimitados": "Delimited files",
        "Camadas vetoriais": "Vector layers",
        "Area de transferencia": "Clipboard",
        "Área de transferência": "Clipboard",
        "Colar tabela copiada": "Paste copied table",
        "Recentes": "Recents",
        "Nenhuma conexao recente...": "No recent connections...",
        "Nenhuma conexão recente...": "No recent connections...",
        "Conexões": "Connections",
        "ConexÃµes": "Connections",
        "Fontes de dados": "Data sources",
        "Arquivos, bancos e serviÃ§os": "Files, databases, and services",
        "Arquivos, bancos e serviços": "Files, databases, and services",
        "Fontes": "Sources",
        "Conectar": "Connect",
        "Colar": "Paste",
        ...
        "Banco espacial": "Spatial database",
        "Banco corporativo": "Enterprise database",
        "Planilhas web": "Web spreadsheets",
        "Dados copiados": "Copied data",
        "XLSX e XLS": "XLSX and XLS",
        "Tabelas": "Tables",
        "Camadas espaciais": "Spatial layers",
        "Dados SQL": "SQL data",
        "Banco Oracle": "Oracle database",
        "Banco MySQL": "MySQL database",
        "CSV e TXT": "CSV and TXT",
        "Preenchimento": "Fill",
        "Grade": "Grid",
        "Eixo": "Axis",
        ...
        "Opacidade": "Opacity",
        "Espessura": "Thickness",
        "Cor dos nomes": "Label color",
        "Tam. nomes": "Label size",
        "Linha zero": "Zero line",
        "Cor linha zero": "Zero line color",
        "Tamanho": "Size",
        ...
        "Auto": "Auto",
        "Percentual": "Percent",
        "Cor dos rotulos": "Label color",
        "Tam. rotulos": "Label size",
        "Prefixo": "Prefix",
        "Sufixo": "Suffix",
        ...
        "Rotulos de dados": "Data labels",
        "Opções": "Options",
        "Opcoes": "Options",
        "Selecione um visual para formatar suas propriedades.": "Select a visual to format its properties.",
        "Formato de dados": "Data format",
        "Legenda": "Legend",
        "Barras e linhas": "Bars and lines",
        "Largura barras": "Bar width",
        "Esp. linha": "Line width",
        "Marcadores": "Markers",
        "Tam. marcador": "Marker size",
        "Caption": "Caption",
        "Cantos": "Corners",
        "Padrão": "Default",
        "Padrao": "Default",
        "Padrão clean": "Clean default",
        "Padrao clean": "Clean default",
        "Padrão suave": "Soft default",
        "Padrao suave": "Soft default",
        "Personalizado": "Custom",
        "Noturno": "Dark",
        "Configuração visual": "Visual configuration",
        "Configuracao visual": "Visual configuration",
        "Configurar canvas": "Configure canvas",
        "Ajuste fundo, grade e densidade visual com visual minimalista.": "Adjust background, grid and visual density with a minimal look.",
        "Cor do fundo": "Background color",
        "Cor da grade": "Grid color",
        "Mostrar grade no modo de edicao": "Show grid in edit mode",
        "Mostrar grade no modo de edição": "Show grid in edit mode",
        "Tamanho da grade": "Grid size",
        "Opacidade da grade (%)": "Grid opacity (%)",
        "Paleta fundo": "Background palette",
        "Paleta grade": "Grid palette",
        "Dica: use fundo claro com grade suave para um visual limpo.": "Tip: use a light background with a subtle grid for a clean visual.",
        "Restaurar padrao": "Reset default",
        "Restaurar padrão": "Reset default",
        "Aplicar": "Apply",
        "Cancelar": "Cancel",
        "Salvar conexÃ£o": "Save connection",
        "Salvar conexao": "Save connection",
        "Save conexÃ£o": "Save connection",
        "Save conexao": "Save connection",
        "Excluir conexÃ£o": "Delete connection",
        "Excluir conexao": "Delete connection",
        "Excluir esta conexÃ£o salva?": "Delete this saved connection?",
        "Excluir esta conexao salva?": "Delete this saved connection?",
        "Pequena": "Small",
        "Normal": "Normal",
        "Grande": "Large",
        "Ampliada": "Extra large",
        "Retos": "Square",
        ...
        "MÃ¡ximo": "Maximum",
        "Maximo": "Maximum",
        "{agg_label} de {field_name}": "{agg_label} of {field_name}",
        "{agg_label} de {value_field}": "{agg_label} of {value_field}",
        "{agg_label} por {dimension_field}": "{agg_label} by {dimension_field}",
        "{agg_label} de {value_field} por {dimension_field}": "{agg_label} of {value_field} by {dimension_field}",
        "Contagem por {dimension_field}": "Count by {dimension_field}",
        "Nova relacao": "New relationship",
        "Relacao": "Relationship",
        "Nao ha outro grafico disponivel para relacionar.": "There is no other chart available to link.",
        "Com qual grafico deseja relacionar '{title}'?": "Which chart do you want to link '{title}' to?",
        "Mudar tipo de grafico": "Change chart type",
        "Personalizar grafico": "Customize chart",
        "Tamanho da fonte": "Font size",
        "Prioridade": "Priority",
        "Tipos": "Types",
        "Barras": "Bars",
        "Barras horizontais": "Horizontal bars",
        "Pizza": "Pie",
        "Rosca": "Donut",
        "Linha": "Line",
        "Area": "Area",
        "Coluna agrupada": "Clustered column",
        "Coluna empilhada": "Stacked column",
        "Barra 100% empilhada": "100% stacked bar",
        "Scatter / bolha": "Scatter / bubble",
        "Comparacao": "Comparison",
        "Tendencia": "Trend",
        "Composicao": "Composition",
        "Indicadores": "Indicators",
        "Analise": "Analysis",
        "Paleta padrao": "Default palette",
        "Cores por categoria": "Colors by category",
        "Paleta roxa": "Purple palette",
        "Paleta azul": "Blue palette",
        "Paleta teal": "Teal palette",
        "Paleta sunset": "Sunset palette",
        "Paleta cinza": "Gray palette",
        "Ordem padrao": "Default order",
        "Ordenar crescente": "Sort ascending",
        "Ordenar decrescente": "Sort descending",
        "Mostrar legenda": "Show legend",
        "Mostrar valores": "Show values",
        "Mostrar percentual": "Show percent",
        "Mostrar grade": "Show grid",
        "Mostrar borda": "Show border",
        "Cor de fundo...": "Background color...",
        "Construir visual": "Build visual",
        "Opções de dados": "Data options",
        "Opcoes de dados": "Data options",
        "Selecione um visual para adicionar dados aos campos.": "Select a visual to add data to Fields.",
        "Selecione um visual para começar.": "Select a visual to start.",
        "Nenhum visual selecionado": "No visual selected",
        "Sem camada": "No layer",
        ...
        "Número": "Number",
        "Cores": "Colors",
        "Predefinicoes de estilo": "Style presets",
        "Predefinições de estilo": "Style presets",
        "Salvar estilo como preset": "Save style as preset",
        "Excluir preset": "Delete preset",
        "Importar dados do Excel": "Import Excel data",
        "Importar arquivo CSV/Parquet": "Import CSV/Parquet file",
        "Importar dados do Google Sheets": "Import Google Sheets data",
        "Gerenciar conexÃµes salvas": "Manage saved connections",
        "Gerenciar conexões salvas": "Manage saved connections",
        "Gerenciar conexoes salvas": "Manage saved connections",
        "CatÃ¡logo de fontes disponÃ­veis": "Available data source catalog",
        "Catálogo de fontes disponíveis": "Available data source catalog",
        "Catalogo de fontes disponiveis": "Available data source catalog",
        "Procurar…": "Browse...",
        "Procurar...": "Browse...",
        "Carregar": "Load",
...
_PHRASE_GLOSSARY = {
    "en": [
        ...
        ("Media de", "Average of"),
        ("Média de", "Average of"),
        ("Media por", "Average by"),
        ("Média por", "Average by"),
        ("Contagem de", "Count of"),
        ("Contagem por", "Count by"),
        ("Minimo de", "Minimum of"),
        ("Mínimo de", "Minimum of"),
        ("Minimo por", "Minimum by"),
        ("Mínimo por", "Minimum by"),
        ("Maximo de", "Maximum of"),
        ("Máximo de", "Maximum of"),
        ("Maximo por", "Maximum by"),
        ("Máximo por", "Maximum by"),
    ...
    "es": [
        ...
        ("Conexões", "Conexiones"),
        ("ConexÃµes", "Conexiones"),
        ("Fontes de dados", "Fuentes de datos"),
        ("Arquivos, bancos e serviÃ§os", "Archivos, bases y servicios"),
        ("Arquivos, bancos e serviços", "Archivos, bases y servicios"),
        ("Fontes", "Fuentes"),
        ("Conectar", "Conectar"),
        ("Colar", "Pegar"),
        ("DisponÃ­vel", "Disponible"),
        ("Disponível", "Disponible"),
        ("Arquivos locais", "Archivos locales"),
        ("Banco de dados", "Base de datos"),
        ("Banco espacial", "Base espacial"),
        ("Banco corporativo", "Base corporativa"),
        ("Planilhas web", "Hojas web"),
        ("Dados copiados", "Datos copiados"),
        ("XLSX e XLS", "XLSX y XLS"),
        ("Tabelas", "Tablas"),
        ("Camadas espaciais", "Capas espaciales"),
        ("Dados SQL", "Datos SQL"),
        ("Banco Oracle", "Base Oracle"),
        ("Banco MySQL", "Base MySQL"),
        ("CSV e TXT", "CSV y TXT"),
        ("Conector:", "Conector:"),
...
def _looks_like_mojibake(text: str) -> bool:
    ...
    source = str(text or "")
    return any(marker in source for marker in ("Ã", "Â", "â€¦", "â†’", "�"))
...
def _load_runtime_map(locale_code: str):
    ...
    # Override weak machine/user-generated terms with curated fallbacks.
...
def _mapping_lookup(mapping: dict, source: str):
    for candidate in _text_variants(source):
        ...
        deaccent = _strip_accents(candidate)
        if deaccent in mapping:
            return str(mapping.get(deaccent) or ""), True
    return source, False
